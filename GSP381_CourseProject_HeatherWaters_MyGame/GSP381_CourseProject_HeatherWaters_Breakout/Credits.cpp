...
void Credits::Initialize(HWND hwnd, InputManager* input, bool fullscreen)
{
	thisInput = input;
	...
	m_pGraphBuilder->RenderFile(L"credits.wmv", NULL);
...
void Credits::Release(HWND hwnd)
{
	m_pControl->Release();
